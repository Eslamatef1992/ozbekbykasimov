    ...
    <div>
        ...
        <div className="bg-mint/50 rounded-2xl px-6 sm:px-10 py-9">
          ...
          <div className="border-t border-forest/15 pt-8 flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3 text-base">
              <IconMail className="text-forest" />
              <span>{settings.contact_email || '—'}</span>
            </div>
            <div className="flex items-center gap-3 text-base">
              <IconPhone className="text-forest" />
      ...
      <section className="pb-20">
        <div className="relative w-full aspect-[16/8] sm:aspect-[16/6]">
          ...
          />
          <div className="absolute top-0 right-0 rtl:right-auto rtl:left-0 w-60 sm:w-72 bg-white/80 backdrop-blur-sm rounded-bl-2xl rtl:rounded-bl-none rtl:rounded-br-2xl flex flex-col items-center text-center px-6 sm:px-8 py-8 pointer-events-none">
